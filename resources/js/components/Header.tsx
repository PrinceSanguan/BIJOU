  ...
  return (
    <header className="w-full bg-transparent absolute top-0 left-0 z-50">
      <nav className="flex items-center justify-between py-6 px-6 w-full">
        ...
        >
          <span className="menuicon-gold-shine-text text-white font-medium tracking-widest text-sm transition-colors cursor-pointer">MENU</span>
          <div className="flex flex-col gap-1">
            <span className="menuicon-gold-shine-bar w-6 h-0.5 bg-white transition-all duration-300 cursor-pointer"></span>
            <span className="menuicon-gold-shine-bar w-6 h-0.5 bg-white transition-all duration-300 cursor-pointer"></span>
            <span className="menuicon-gold-shine-bar w-6 h-0.5 bg-white transition-all duration-300 cursor-pointer"></span>
          </div>
        </button>
