    ...
    return (
        <section className="py-12 px-6 md:px-8 lg:px-12 m-6">
            <div className="max-w-7xl mx-auto text-center mb-12">
                ...
                <p className="text-lg font-space" style={{ color: '#0E5248' }}>Lorem ipsum dolor sit amet. Est dolorem itaque quo distinctio corporis ad fugiat repudiandae sit quia necessitatibus<br />aut eveniet dignissimos sit iste</p>
            </div>
            <div className="w-full flex justify-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1728px] px-4">
                    <div className="w-full max-w-[477px] h-[500px] bg-white rounded-lg overflow-hidden shadow-lg mx-auto">
                        <img 
                            src={teamImage} 
                            alt="John Doe" 
