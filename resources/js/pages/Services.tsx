  ...
  return (
    <>
      <SEOHead
        ...
        description="Discover comprehensive property management services in Sheffield with Bijou Group. We handle rent collection, arrears, maintenance, tenant find, compliance, and more for HMO and single-let landlords. Maximize rental income, ensure legal compliance, and enjoy hassle-free management."
