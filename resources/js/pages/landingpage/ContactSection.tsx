...
export function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-32 h-16 bg-[#e5e5e0] rounded-bl-3xl opacity-60"></div>
      <div className="absolute bottom-0 left-0 w-24 h-12 bg-[#e5e5e0] rounded-tr-3xl opacity-50"></div>
