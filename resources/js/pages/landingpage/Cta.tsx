...
export function Cta() {
  return (
    <section className="w-full max-w-7xl mx-auto mt-24 mb-16 px-2 sm:px-4 flex flex-col md:flex-row items-center justify-between gap-8 overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col items-start justify-center min-w-0 w-full max-w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-2 w-full max-w-full">
          <button className="bg-white text-[#12443A] border border-gray-200 rounded-lg px-4 sm:px-6 py-2 shadow-md hover:shadow-lg font-medium text-sm sm:text-[15px] transition-all duration-200 w-full sm:w-auto">
