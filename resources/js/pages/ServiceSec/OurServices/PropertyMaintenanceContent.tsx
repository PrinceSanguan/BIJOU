...
const PropertyMaintenanceContent: React.FC = () => (
  ...
  <h1 className="text-4xl md:text-6xl font-bold text-center text-[#EFBF04] my-8 font-serif" aria-label="Property Maintenance & Repairs in Sheffield">Property Maintenance & Repairs in Sheffield</h1>
    ...
    <div className="text-center mt-4 mb-8">
      ...
      <a href="#" className="bg-[#0E5248] text-[#EFBF04] px-6 py-3 rounded font-bold">Report a Repair Today</a>
    </div>
    <h2 className="text-2xl font-bold mt-10">Don't Let Property Problems Become Expensive Disasters</h2>
    ...
    <h2 className="text-2xl font-bold mt-10">Our Professional Maintenance & Repair Process</h2>
    <h3 className="text-xl font-bold mt-6">24/7 Emergency Response System</h3>
    <p>Urgent issues like heating failures, water leaks, electrical faults, and security problems receive immediate attention. Our emergency hotline connects you with qualified tradespeople within 2 hours, preventing minor problems becoming major disasters that could cost thousands in damages.</p>
    ...
    <h2 className="text-2xl font-bold mt-10">Why Choose Our Service</h2>
    ...
    <h2 className="text-2xl font-bold mt-10">Sheffield Property Maintenance Expertise</h2>
    ...
    <p className="mt-4 text-lg text-center">Local Insight: Over 80% of Sheffield landlords cite maintenance delays as the primary source of tenant complaints and void periods. Our rapid response system prevents these issues, maintaining tenant satisfaction and rental income continuity.</p>
    <p className="mt-4 text-lg text-center">Proven Results: In 2024, we reduced average emergency call-outs by 50% for our managed properties through proactive maintenance scheduling and professional oversight.</p>
    <h2 className="text-2xl font-bold mt-10">Trusted by Sheffield's Professional Landlords</h2>
    <div className="mt-6">
      <blockquote className="border-l-4 border-[#EFBF04] pl-4 italic mb-4">
        "Their emergency response is incredible. When our HMO lost heating on Christmas Eve, they had an engineer there within 90 minutes. Tenants were delighted with the professional service." — Rachel Thompson, 6-Property HMO Portfolio
      </blockquote>
      <blockquote className="border-l-4 border-[#EFBF04] pl-4 italic mb-4">
        "The routine maintenance programme identified a potential boiler issue before it failed. Saved us hundreds in emergency repair costs and prevented tenant disruption completely." — Mark Stevens, Crookes Landlord
      </blockquote>
      <blockquote className="border-l-4 border-[#EFBF04] pl-4 italic mb-4">
        "Professional, reliable, and transparent pricing. Their digital reports are fantastic for insurance claims and maintaining property records. Highly recommended for serious landlords." — Lisa Chen, Property Investor
      </blockquote>
    </div>
    ...
    <h2 className="text-2xl font-bold mt-10">Property Maintenance FAQ</h2>
    <div className="mt-6">
      <h3 className="text-xl font-bold mt-4">How quickly do you respond to emergency repairs?</h3>
      <p>Our 24/7 emergency hotline ensures response within 2 hours for urgent issues like heating failures, water leaks, or electrical faults. Non-emergency repairs are typically scheduled within 24-48 hours depending on complexity and parts availability.</p>
    ...
    <h2 className="text-2xl font-bold mt-10">Protect Your Investment with Professional Property Care</h2>
    <p className="mt-4">Don't wait for small problems to become expensive disasters. Our comprehensive maintenance service keeps your property safe, compliant, and in excellent condition whilst ensuring tenant satisfaction and protecting your investment value.</p>
    <p className="mt-4">Join 200+ Sheffield landlords who trust us with their property maintenance. Book your assessment today.</p>
    <div className="text-center mt-8 mb-8">
      <a href="#" className="bg-[#EFBF04] text-[#0E5248] px-6 py-3 rounded font-bold mr-4">Book Property Assessment</a>
      <span className="font-bold ml-4">Emergency: 07XXX XXXXXX</span>
      <span className="font-bold ml-4">Email: maintenance@bijourelocation.co.uk</span>
    </div>
  </>
);
