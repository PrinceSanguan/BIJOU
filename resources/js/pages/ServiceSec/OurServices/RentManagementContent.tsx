...
const RentManagementContent: React.FC = () => (
  <>
    ...
    <div className="text-center mt-4 mb-8">
      ...
      <a href="#" className="bg-[#0E5248] text-[#EFBF04] px-6 py-3 rounded font-bold">Book Rent Collection Service Today</a>
    </div>
    <h2 className="text-2xl font-bold mt-10">Late Rent Payments and Sleepless Nights Over Arrears</h2>
    <p className="mt-4 text-lg text-center">Sheffield landlords lose thousands annually due to rent arrears and late payments. The National Residential Landlords Association reports that 47% of UK landlords experienced rent arrears in 2024, with average collection delays costing £2,100 per property yearly.</p>
    ...
    <div className="text-center mt-4 mb-8">
      <a href="#" className="bg-[#EFBF04] text-[#0E5248] px-6 py-3 rounded font-bold">Discover how we guarantee your rental income →</a>
    </div>
    <h2 className="text-2xl font-bold mt-10">Our Comprehensive 5-Step Rent Management System</h2>
    ...
    <h2 className="text-2xl font-bold mt-10">Why Sheffield Landlords Choose Our Rent Collection Service</h2>
    ...
    <p className="mt-4 text-lg text-center">Results That Matter: 95% on-time collection rate, average arrears reduction of 75%, zero landlord time spent chasing payments.</p>
    <h2 className="text-2xl font-bold mt-10">Sheffield Property Management Expertise</h2>
    ...
    <p className="mt-4 text-lg text-center">Sheffield Market Insight: Research shows over 70% of Sheffield landlords experience late rent payments annually, with HMO properties facing 40% higher arrears risk. Our systematic approach prevents these issues before they impact your income.</p>
    <p className="mt-4 text-lg text-center">Proven Track Record: In 2024, we managed rent collection for 180+ Sheffield properties, achieving 97% collection rates and reducing average arrears duration from 28 days to just 6 days.</p>
    <h2 className="text-2xl font-bold mt-10">Trusted by Sheffield's Most Successful Landlords</h2>
    <div className="mt-6">
      <blockquote className="border-l-4 border-[#EFBF04] pl-4 italic mb-4">
        "Since switching to Bijou's rent management system, I haven't chased a single late payment in 18 months. The monthly reports are fantastic, and my accountant loves the detailed records." — Michael Thompson, 12-Property Portfolio Owner
      </blockquote>
      <blockquote className="border-l-4 border-[#EFBF04] pl-4 italic mb-4">
        "Their professional approach to arrears management saved me thousands. They recovered 6 months' outstanding rent I thought was lost forever whilst maintaining good tenant relationships." — Sarah Chen, HMO Specialist, Broomhill
      </blockquote>
      <blockquote className="border-l-4 border-[#EFBF04] pl-4 italic mb-4">
        "As a busy investor, their automated system is invaluable. I receive my rent on time every month and only get contacted when there's something important to know." — David Foster, Buy-to-Let Portfolio
      </blockquote>
    </div>
    ...
    <h2 className="text-2xl font-bold mt-10">Rent Management FAQ - Sheffield Landlords</h2>
    <div className="mt-6">
      <h3 className="text-xl font-bold mt-4">How quickly is rent typically collected each month?</h3>
      <p>With direct debit systems, 85% of tenants pay automatically on the due date. Remaining payments are collected within 48-72 hours through our proactive reminder system and tenant contact procedures.</p>
      ...
      <p>Our transparent fee structure ranges from 8-12% of collected rent depending on property type and services required. No hidden charges, no setup fees, and no charges for uncollected rent.</p>
    </div>
    <h2 className="text-2xl font-bold mt-10">Sheffield's Rent Collection Specialists</h2>
    <p className="mt-4">Established in 2016, Bijou Relocation has built Sheffield's most reliable rent management service. Our dedicated team combines modern technology with personal service, ensuring landlords receive consistent rental income without stress or time investment.</p>
    <p className="mt-4">Our Expertise: 8+ years Sheffield lettings | 180+ properties under management | 97% collection rate | HMO specialists | Legal compliance experts</p>
    <h2 className="text-2xl font-bold mt-10">Ready to Secure Guaranteed Rental Income and Eliminate Payment Stress?</h2>
    <p className="mt-4">Stop losing sleep over late rent payments and spending hours chasing arrears. Our proven rent management system ensures reliable monthly income whilst protecting your investment through professional, compliant collection procedures.</p>
    <p className="mt-4">Join 200+ satisfied Sheffield landlords who never worry about rent collection again. Book your free consultation today and discover how we can transform your rental income management.</p>
    <div className="text-center mt-8 mb-8">
      <a href="#" className="bg-[#EFBF04] text-[#0E5248] px-6 py-3 rounded font-bold mr-4">Get Your Free Consultation</a>
      <span className="font-bold ml-4">Call: 0114 XXX XXXX</span>
      <span className="font-bold ml-4">Email: rentcollection@bijourelocation.co.uk</span>
    </div>
